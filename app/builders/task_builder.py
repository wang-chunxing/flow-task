...
class TaskBuilder:
    def __init__(self, name: str):
        ...
        self.name: str = name
        self._scheduler_type: str = "immediate"
    ...
    def set_queue(self, queue: Queue) -> "TaskBuilder":
        self._queue = queue
        return self
        ...
        return Task(
            ...
            scheduler_config=SchedulerPolicy(
                ...
                cron_expression=self._scheduler_args["cron_expression"]
                    if "cron_expression" in self._scheduler_args else ""
            ),
